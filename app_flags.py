...
# 可以再命令行中运行也是比较方便，如果只写 python test3_app_flags.py 则代码运行时默认程序里面设置的默认设置
# 若 python test3_app_flags.py --train_data_path <绝对路径 train.txt> --max_sentence_len 100
